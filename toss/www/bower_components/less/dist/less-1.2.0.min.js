...
(function (a, b) {
          ...
          if (
            ...
            try {
              new d.Parser({
                ...
                if (a) return w(a, i);
                try {
                  c(d, b, { local: !1, lastModified: g, remaining: f }),
  ...
  function s(a, b, c, e) {
    ...
    typeof f.overrideMimeType == "function" && f.overrideMimeType("text/css"),
      ...
      f.send(null),
      g
        ? f.status === 0 || (f.status >= 200 && f.status < 300)
          ? c(f.responseText)
          : e(f.status, a)
        : h
  ...
  {}.toString.call(environment) === "[object Environment]"
    ? (typeof a == "undefined" ? (d = {}) : (d = a.less = {}),
      ...
      (d.mode = "rhino"))
    : typeof a == "undefined"
    ? ((d = exports), (f = c("./tree")), (d.mode = "node"))
    : (typeof a.less == "undefined" && (a.less = {}),
      (d = a.less),
      (f = a.less.tree = {}),
      (d.mode = "browser")),
    (d.Parser = function x(a) {
      function s() {
        (i = l[h]), (j = g), (m = g);
      }
      function t() {
      ...
      function v(a) {
        ...
        if (typeof a == "string")
          (c = b.charAt(g) === a ? a : null), (e = 1), u();
        else {
          u();
          if ((c = a.exec(l[h]))) e = c[0].length;
          else return null;
        }
        if (c) {
      ...
      function A(a, c) {
        var d = b.split("\n"),
          ...
          f = e.line,
          g = e.column;
        (this.type = a.type || "SyntaxError"),
          (this.message = a.message),
          (this.filename = a.filename || c.filename),
          (this.index = a.index),
          (this.line = typeof f == "number" ? f + 1 : null),
          (this.callLine = a.call && z(a.call) + 1),
          (this.callExtract = d[z(a.call)]),
          (this.stack = a.stack),
          (this.column = g),
          (this.extract = [d[f - 1], d[f], d[f + 1]]);
      }
      var b,
        g,
        h,
        ...
        (n = {
                  ...
                  (e.lastIndex = l),
                    ...
                    !k &&
                      ...
                      (n === "/" || n === "*") &&
                        (h = f.exec(b)) &&
                        h.index === l &&
                        ((l += h[0].length), i.push(h[0]), (m = b.charAt(l))));
                  if (m === "{" && !k && !j) g++, i.push(m);
                  else if (m === "}" && !k && !j)
                    g--, i.push(m), (c[++d] = i = []);
            ...
            j.toCSS = (function (b) {
              ...
              return function (e, g) {
                ...
                try {
                  var i = b
                    .call(this, { frames: h })
                    .toCSS([], { compress: e.compress || !1 });
                } catch (j) {
                  throw new A(j, a);
                }
                if (n.imports.error) throw n.imports.error;
                return e.yuicompress && d.mode === "node"
                  ? c("./cssmin").compressor.cssmin(i)
                  : e.compress
                  ? i.replace(/(\s)+/g, "$1")
                  : i;
              };
          ...
          parsers: {
            ...
            entities: {
              ...
              keyword: function () {
                var a;
                if ((a = v(/^[_A-Za-z-][_A-Za-z0-9-]*/)))
                  return f.colors.hasOwnProperty(a)
                    ? new f.Color(f.colors[a].slice(1))
                    : new f.Keyword(a);
              },
              call: function () {
                var a,
              ...
              arguments: function () {
                var a = [],
                  b;
                while (
                  (b = v(this.entities.assignment) || v(this.expression))
                ) {
                  a.push(b);
                  if (!v(",")) break;
                }
              ...
              literal: function () {
                return (
                  v(this.entities.dimension) ||
                  v(this.entities.color) ||
                  v(this.entities.quoted)
                );
              },
              assignment: function () {
                var a, b;
                if ((a = v(/^\w+(?=\s?=)/i)) && v("=") && (b = v(this.entity)))
              ...
              url: function () {
                ...
                return (
                  (a =
                    ...
                    v(this.entities.dataURI) ||
                    v(/^[-\w%@$\/.&=:;#+?~]+/) ||
                    ""),
                  w(")"),
                  new f.URL(
                    a.value || a.data || a instanceof f.Variable
                      ? a
                      : new f.Anonymous(a),
                    r.paths
                  )
              ...
              variable: function () {
                var a,
                  c = g;
                if (b.charAt(g) === "@" && (a = v(/^@@?[\w-]+/)))
                  return new f.Variable(a, c);
              },
              color: function () {
                var a;
                if (
                  b.charAt(g) === "#" &&
                  (a = v(/^#([a-fA-F0-9]{6}|[a-fA-F0-9]{3})/))
                )
            ...
            shorthand: function () {
              var a, b;
              if (!y(/^[@\w.%-]+\/[@\w.-]+/)) return;
              if ((a = v(this.entity)) && v("/") && (b = v(this.entity)))
            ...
            mixin: {
              call: function () {
                ...
                while (
                  ...
                  a.push(new f.Element(d, c, g)), (d = v(">"));
                v("(") && (e = v(this.entities.arguments)) && v(")"),
                  v(this.important) && (j = !0);
                if (a.length > 0 && (v(";") || y("}")))
                  return new f.mixin.Call(a, e, h, j);
              },
              definition: function () {
                var a,
                  c = [],
                ...
                if (
                  ...
                  while (
                    (h =
                      v(this.entities.variable) ||
                      v(this.entities.literal) ||
                      v(this.entities.keyword))
                  ) {
                    h instanceof f.Variable
                      ? v(":")
                        ? ((i = w(this.expression, "expected expression")),
                  ...
                  w(")"),
                    v(/^when/) &&
                      (j = w(this.conditions, "expected condition")),
                    (e = v(this.block));
            ...
            entity: function () {
              return (
                ...
                v(this.entities.variable) ||
                v(this.entities.url) ||
                v(this.entities.call) ||
                v(this.entities.keyword) ||
                v(this.entities.javascript) ||
                v(this.comment)
              );
            },
            end: function () {
            ...
            alpha: function () {
              ...
              if ((a = v(/^\d+/) || v(this.entities.variable)))
                return w(")"), new f.Alpha(a);
            },
            element: function () {
              var a, b, c, d;
              (c = v(this.combinator)),
                ...
                a ||
                  (v("(") &&
                    (d = v(this.entities.variable)) &&
                    v(")") &&
                    (a = new f.Paren(d)));
              if (a) return new f.Element(c, a, g);
              if (c.value && c.value.charAt(0) === "&")
                return new f.Element(c, null, g);
            },
            combinator: function () {
              var a,
                c = b.charAt(g);
            ...
            attribute: function () {
              var a = "",
                ...
                d;
              if (!v("[")) return;
              if ((b = v(/^[a-zA-Z-]+/) || v(this.entities.quoted)))
                (d = v(/^[|~*$^]?=/)) &&
                (c = v(this.entities.quoted) || v(/^[\w-]+/))
            ...
            rule: function () {
              ...
              if ((a = v(this.variable) || v(this.property))) {
                a.charAt(0) != "@" && (i = /^([^@+\/'"*`(;{}-]*);/.exec(l[h]))
                  ? ((g += i[0].length - 1), (c = new f.Anonymous(i[1])))
                  : a === "font"
                  ? (c = v(this.font))
                  : (c = v(this.value)),
                  (e = v(this.important));
            ...
            import: function () {
              ...
              if (
                v(/^@import\s+/) &&
                (a = v(this.entities.quoted) || v(this.entities.url))
              ) {
            ...
            mediaFeature: function () {
              var a = [];
              do
                if ((e = v(this.entities.keyword))) a.push(e);
                else if (v("(")) {
                  (p = v(this.property)), (e = v(this.entity));
                  if (!v(")")) return null;
                  if (p && e)
                    a.push(new f.Paren(new f.Rule(p, e, null, g, !0)));
                  else if (e) a.push(new f.Paren(e));
                  else return null;
                }
              while (e);
              ...
              if ((a = v(this.multiplication))) {
                while (
                  (d =
                    v(/^[-+]\s+/) ||
                    (b.charAt(g - 1) != " " && (v("+") || v("-")))) &&
                  (c = v(this.multiplication))
                )
                  e = new f.Operation(d, [e || a, c]);
                return e || a;
              }
            },
            conditions: function () {
            ...
            condition: function () {
              ...
              if (
                ...
                return (
                  ...
                  w(")"),
                  v(/^and/) ? new f.Condition("and", c, v(this.condition)) : c
                );
            },
            operand: function () {
              var a,
  ...
  if (d.mode === "browser" || d.mode === "rhino")
    d.Parser.importer = function (a, b, c, d) {
      a.charAt(0) !== "/" && b.length > 0 && (a = b[0] + a),
        o({ href: a, title: a, type: d.mime }, c, !0);
    };
  (function (a) {
    function b(b) {
    ...
    (function (a) {
      (a.Directive = function (b, c, d) {
        ...
        (a.Directive.prototype = {
          ...
          eval: function (a) {
            return (
              (this.features = this.features && this.features.eval(a)),
        ...
        (a.Import.prototype = {
          ...
          eval: function (b) {
            ...
            return this.features
              ? new a.Directive("@media", c.rules, this.features.value)
              : c.rules;
          },
        });
    })(c("../tree")),
      ...
      (a.mixin = {}),
        ...
        (a.mixin.Definition.prototype = {
          ...
          eval: function (b, c, d) {
            ...
            for (
              var i = 0;
              i < Math.max(this.params.length, c && c.length);
              i++
            )
        ...
        (a.Ruleset.prototype = {
          ...
          toCSS: function (b, c) {
            ...
            for (var j = 0; j < this.rules.length; j++)
              (i = this.rules[j]),
                i.rules || i instanceof a.Directive
                  ? f.push(i.toCSS(g, c))
  ...
  for (var l = 0; l < j.length; l++)
    (j[l].rel === "stylesheet/less" ||
      (j[l].rel.match(/stylesheet/) && j[l].type.match(k))) &&
      d.sheets.push(j[l]);
  (d.refresh = function (a) {
    ...
    (b = c = new Date()),
      n(function (a, d, e) {
        e.local
          ? v("loading " + d.href + " from cache.")
          : (v("parsed " + d.href + " successfully."),
            r(a.toCSS(), d, e.lastModified)),
          v("css for " + d.href + " generated in " + (new Date() - c) + "ms"),
          e.remaining === 0 && v("css generated in " + (new Date() - b) + "ms"),
          (c = new Date());
      }, a),
      m();
  }),
