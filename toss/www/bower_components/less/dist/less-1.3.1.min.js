...
(function (e, t) {
      ...
      g(
        ...
        function (e, u) {
          if (
            ...
            h &&
            u &&
            new Date(u).valueOf() === new Date(h.timestamp).valueOf()
          )
            ...
            try {
              (o[f] = e),
                new r.Parser({
                  ...
                  if (r) return E(r, f);
                  try {
                    n(r, i, e, t, { local: !1, lastModified: u, remaining: s }),
              ...
              (c = (function (e) {
                ...
                for (var c = 0, h, p; c < s.length; c++) {
                  (r.lastIndex = c),
                    ...
                    (a = o.exec(s)) &&
                      a.index === c &&
                      ((c += a[0].length), f.push(a[0]), (h = s.charAt(c))),
                    !l &&
                      h === "/" &&
                      ((p = s.charAt(c + 1)),
                      (p === "/" || p === "*") &&
  ...
  if (r.mode === "browser" || r.mode === "rhino")
    r.Parser.importer = function (e, t, n, r) {
      !/^([a-z-]+:)?\//.test(e) && t.length > 0 && (e = t[0] + e),
        d(
          { href: e, title: e, type: r.mime, contents: r.contents },
          function (i) {
            i && typeof r.errback == "function"
              ? r.errback.call(null, e, t, n, r)
        ...
        (e.Media.prototype = {
          ...
          eval: function (t) {
            ...
            return (
              ...
              (r.features = this.features.eval(t)),
              t.frames.unshift(this.ruleset),
              (r.ruleset = this.ruleset.eval(t)),
              t.frames.shift(),
              (t.mediaBlocks[n] = r),
              t.mediaPath.pop(),
              t.mediaPath.length === 0 ? r.evalTop(t) : r.evalNested(t)
            );
          },
          variable: function (t) {
            return e.Ruleset.prototype.variable.call(this.ruleset, t);
                  ...
                  if (t[o].match(n, e))
                    try {
                      Array.prototype.push.apply(
                        r,
                        t[o].eval(e, this.arguments, this.important).rules
                      ),
                        (i = !0);
                    } catch (u) {
                      throw {
        ...
        (e.mixin.Definition.prototype = {
          ...
          evalParams: function (t, n) {
            ...
            for (var o = 0, u, a; o < this.params.length; o++) {
              s = n && n[o];
              if (s && s.name) {
                r.rules.unshift(new e.Rule(s.name, s.value.eval(t))),
                  n.splice(o, 1),
                  o--;
                continue;
              }
          ...
          eval: function (t, n, r) {
            ...
            for (
              var f = 0;
              f < Math.max(this.params.length, n && n.length);
              f++
            )
              o.push((n[f] && n[f].value) || this.params[f].value);
            return (
              i.rules.unshift(
                new e.Rule("@arguments", new e.Expression(o).eval(t))
              ),
              (u = r
          ...
          eval: function (n) {
            ...
            return (
              typeof e != "undefined" &&
                ...
                (r.value =
                  this.paths[0] +
                  (r.value.charAt(0) === "/" ? r.value.slice(1) : r.value)),
  ...
  var s = /^(file|chrome(-extension)?|resource|qrc|app):/.test(
    location.protocol
  );
  (r.env =
    r.env ||
  ...
  for (var c = 0; c < f.length; c++)
    (f[c].rel === "stylesheet/less" ||
      (f[c].rel.match(/stylesheet/) && f[c].type.match(l))) &&
      r.sheets.push(f[c]);
    ...
    (t = n = new Date()),
      p(function (e, r, i, s, o) {
        o.local
          ...
          : (w("parsed " + s.href + " successfully."),
            m(r.toCSS(), s, o.lastModified)),
          w("css for " + s.href + " generated in " + (new Date() - n) + "ms"),
          o.remaining === 0 && w("css generated in " + (new Date() - t) + "ms"),
          (n = new Date());
      }, e),
      h();
  }),
