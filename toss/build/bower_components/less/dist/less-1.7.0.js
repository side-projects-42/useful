...
(function (window, undefined) {
      ...
      parse: function (str, callback, additionalData) {
        ...
        globalVars =
          additionalData && additionalData.globalVars
            ? less.Parser.serializeVars(additionalData.globalVars) + "\n"
            : "";
        modifyVars =
        ...
        if (globalVars || (additionalData && additionalData.banner)) {
          preText =
            (additionalData && additionalData.banner
              ...
              : "") + globalVars;
          parser.imports.contentsIgnoredChars[env.currentFileInfo.filename] =
            preText.length;
        }
        ...
        chunks = (function (input) {
          ...
          for (
            parserCurrentIndex = 0;
            parserCurrentIndex < len;
            parserCurrentIndex++
          ) {
            ...
            switch (cc) {
              ...
              case 96: // ", ' and `
                ...
                for (
                  parserCurrentIndex = parserCurrentIndex + 1;
                  parserCurrentIndex < len;
                  parserCurrentIndex++
                ) {
              ...
              case 47: // /, check for comment
                ...
                if (cc2 == 47) {
                  // //, find lnfeed
                  for (
                    parserCurrentIndex = parserCurrentIndex + 2;
                    parserCurrentIndex < len;
                    parserCurrentIndex++
                  ) {
                    cc2 = input.charCodeAt(parserCurrentIndex);
              ...
              case 42: // *, check for unmatched */
                if (
                  parserCurrentIndex < len - 1 &&
                  input.charCodeAt(parserCurrentIndex + 1) == 47
                ) {
      ...
      parsers: (parsers = {
        ...
        entities: {
          ...
          color: function () {
            ...
            if (
              input.charAt(i) === "#" &&
              (rgb = $re(/^#([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3})/))
            ) {
            ...
            while (true) {
              ...
              if (val && val instanceof tree.Variable) {
                if ($char(":")) {
                  ...
                  value =
                    (isCall && parsers.detachedRuleset()) ||
                    parsers.expression();
        ...
        rule: function (tryAnonymous) {
          ...
          if (name) {
            ...
            if (!value) {
              ...
              value =
                !tryAnonymous && (env.compress || isVariable)
  ...
  (function (tree) {
    tree.functions = {
      ...
      luminance: function (color) {
        ...
        return new tree.Dimension(
          Math.round(luminance * color.alpha * 100),
          "%"
        );
      },
        ...
        for (i = 0; i < args.length; i++) {
          ...
          currentUnified =
            current.unit.toString() === "" && unitClone !== undefined
              ? new tree.Dimension(current.value, unitClone).unify()
              : current.unify();
          unit =
          ...
          referenceUnified =
            order[j].unit.toString() === "" && unitClone !== undefined
              ? new tree.Dimension(order[j].value, unitClone).unify()
              : order[j].unify();
          if (
            ...
            for (m = 0; m < candidates.length; m++) {
              ...
              if (candidate === defNone || candidate === defaultResult) {
                try {
                  ...
                  Array.prototype.push.apply(
                    rules,
                    mixin.evalCall(env, args, this.important).rules
                  );
                } catch (e) {
                  throw {
                    message: e.message,
    ...
    tree.Rule.prototype = {
      ...
      eval: function (env) {
        ...
        if (typeof name !== "string") {
          ...
          name =
            name.length === 1 && name[0] instanceof tree.Keyword
              ? name[0].value
              : evalName(env, name);
        }
    ...
    tree.Ruleset.prototype = {
      ...
      eval: function (env) {
        ...
        for (i = 0; i < rsRuleCnt; i++) {
          if (
            rsRules[i] instanceof tree.mixin.Definition ||
            rsRules[i] instanceof tree.DetachedRuleset
          ) {
        ...
        for (i = 0; i < rsRules.length; i++) {
          ...
          if (
            !(
              ...
              rule instanceof tree.DetachedRuleset
            )
          ) {
      ...
      visitRuleset: function (rulesetNode, visitArgs) {
        ...
        if (!rulesetNode.root) {
          ...
          if (
            ...
            (rulesetNode.rules && rulesetNode.rules.length > 0)
          ) {
            rulesets.splice(0, 0, rulesetNode);
          }
        }
  ...
  // Defaults to 2
  less.logLevel =
    typeof less.logLevel != "undefined"
      ? less.logLevel
