        ...
        (F = {
          ...
          parsers: (G = {
                ...
                if ("." === l || "#" === l) {
                  for (d(); ; ) {
                    if (
                      ...
                      break;
                    (f = new w.Element(h, g, b, a.currentFileInfo)),
                      c ? c.push(f) : (c = [f]),
                      (h = j(">"));
                  }
                  return (
                    j("(") && ((k = this.args(!0).args), m(")")),
                    G.important() && (n = !0),
                    c && (j(";") || p("}"))
                      ? new w.mixin.Call(c, k, o, a.currentFileInfo, n)
                      : (e(), void 0)
                  );
                }
              },
              ...
              return (
                ...
                b ||
                  (j("(") &&
                    ...
                    j(")") &&
                    (b = new w.Paren(d))),
                b ? new w.Element(c, b, e, a.currentFileInfo) : void 0
              );
            },
            combinator: function () {
              var a = u.charAt(x);
            ...
            selector: function (b) {
              ...
              return c
                ? new w.Selector(c, d, i, j, a.currentFileInfo)
                : (d &&
                    n(
