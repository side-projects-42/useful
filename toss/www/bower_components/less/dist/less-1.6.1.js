      ...
      parse: function (str, callback, additionalData) {
        ...
        chunks = (function (input) {
          ...
          if (level !== 0) {
            ...
            return fail(
              parenLevel > 0 ? "missing closing `)`" : "missing opening `(`"
            );
          }
      ...
      parsers: (parsers = {
        ...
        rule: function (tryAnonymous) {
          ...
          if (name) {
            ...
            value =
              !tryAnonymous &&
              (env.compress || (name.charAt && name.charAt(0) === "@"))
        ...
        for (i = 0; i < env.frames.length; i++) {
          if ((mixins = env.frames[i].find(this.selector)).length > 0) {
            ...
            for (m = 0; m < candidates.length; m++) {
              ...
              if (
                !candidate.matchIfDefault ||
                candidate.matchIfDefaultValue == (candidates.length == 1)
              ) {
                try {
