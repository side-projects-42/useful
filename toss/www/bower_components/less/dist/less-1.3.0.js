...
(function (window, undefined) {
      ...
      parsers: {
        ...
        entities: {
          ...
          url: function () {
            ...
            return new tree.URL(
              value.value || value.data || value instanceof tree.Variable
                ? value
  ...
  (function (tree) {
    ...
    tree.Selector.prototype.toCSS = function (env) {
      ...
      return (this._css = this.elements
        .map(function (e) {
          if (typeof e === "string") {
            return " " + e.trim();
          } else {
