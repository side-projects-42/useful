...
!(function (a, b) {
  ...
  function i(a, b) {
    v.errorReporting && "html" !== v.errorReporting
      ? "console" === v.errorReporting
        ? f(a, b)
        : "function" == typeof v.errorReporting && v.errorReporting("add", a, b)
      : h(a, b);
  }
  function j(a) {
  ...
  function l(a) {
    v.errorReporting && "html" !== v.errorReporting
      ? "console" === v.errorReporting
        ? k(a)
        : "function" == typeof v.errorReporting && v.errorReporting("remove", a)
      : j(a);
  }
  function m(a) {
    for (
      ...
      if (((b = c[d]), b.type.match(B))) {
        ...
        (e.filename = document.location.href.replace(/#.*$/, "")),
          (a || v.globalVars) && (e.useFileCache = !0);
        var g = (function (a) {
          return function (b, c) {
  ...
  function r(b, c, d, e) {
    ...
    if (
      (c
        ...
        : ((h.entryPath = f.path),
          (h.rootpath = v.rootpath || f.path),
          (h.rootFilename = g),
          (h.relativeUrls = e.relativeUrls)),
      h.relativeUrls &&
        (h.rootpath = e.rootpath
          ? n(e.rootpath + o(f.path, h.entryPath)).path
          : f.path),
      e.useFileCache && D[g])
    )
      try {
  ...
  function s(a, b, c, d, e) {
    ...
    (f.mime = a.type),
      (e || v.globalVars) && (f.useFileCache = !0),
      r(
        a.href,
        null,
        function (h, i, j, k, m) {
          if (m) {
            ...
            if (
              ...
              o &&
              m.lastModified &&
              new Date(m.lastModified).valueOf() === new Date(o).valueOf()
            )
            ...
            i
              ? ((f.currentFileInfo = k),
                new v.Parser(f).parse(
                  ...
                  { modifyVars: e, globalVars: v.globalVars }
                ))
              : b(h, null, null, a, m, j);
        },
        f,
  ...
  function u() {
    "development" === v.env
      ? ((v.optimization = 0),
        (v.watchTimer = setInterval(function () {
          v.watchMode &&
  ...
  ("undefined" == typeof a.less || "undefined" != typeof a.less.nodeType) &&
    ...
    (v.mode = "browser");
  var v, w;
  v === b && ((v = exports), (w = c("./tree")), (v.mode = "node")),
    (v.Parser = function (a) {
      function d() {
        (z = D), (A = E = x);
      }
      ...
      function m(a, b) {
        return u.charAt(x) === a
          ? (k(1), a)
          : (n(b || "expected '" + a + "' got '" + u.charAt(x) + "'"), void 0);
      }
      function n(a, b) {
        var c = new Error(a);
      ...
      function s(a, b, d) {
        ...
        return (
          "browser" !== v.mode &&
            "rhino" !== v.mode &&
            (e = c("path").resolve(e)),
          { lineNumber: r(a, b).line + 1, fileName: e }
        );
      }
      function t(a, b) {
        var c = q(a, b),
              ...
              : v.Parser.fileLoader(
                  ...
                  function (b, e, f, h) {
                    ...
                    (i.currentFileInfo = h),
                      ...
                      d.inline
                        ? g(null, e, f)
                        : new v.Parser(i).parse(e, function (a, b) {
                            g(a, b, f);
                          });
                  },
                  a
        ...
        (F = {
          ...
          parse: function (d, e, f) {
            ...
            if (
              ...
              (j =
                f && f.globalVars
                  ? v.Parser.serializeVars(f.globalVars) + "\n"
                  : ""),
              (k =
                f && f.modifyVars
                  ? "\n" + v.Parser.serializeVars(f.modifyVars)
                  : ""),
              (j || (f && f.banner)) &&
                ((m = (f && f.banner ? f.banner : "") + j),
                (F.imports.contentsIgnoredChars[a.currentFileInfo.filename] =
                  m.length)),
              (d = d.replace(/\r\n/g, "\n")),
              (u = d = m + d.replace(/^\uFEFF/, "") + k),
              (F.imports.contents[a.currentFileInfo.filename] = d),
              (C = (function (b) {
                function c(b, c) {
                  l = new t(
                    {
                ...
                return 0 !== p
                  ? p > 0
                    ...
                    : c("missing opening `{`", f)
                  : 0 !== q
                  ? c(q > 0 ? "missing closing `)`" : "missing opening `(`")
                  : (d(!0), r);
              })(d)),
              l)
            )
            ...
            D = C[0];
            try {
              (g = new w.Ruleset(null, this.parsers.primary())),
                (g.root = !0),
                (g.firstRoot = !0);
            } catch (n) {
              return e(new t(n, a));
                ...
                return function (e, f) {
                  ...
                  "object" != typeof f ||
                    ...
                    ((f = Object.keys(f).map(function (a) {
                      var b = f[a];
                      return (
                        b instanceof w.Value ||
                          (b instanceof w.Expression ||
                            (b = new w.Expression([b])),
                          (b = new w.Value([b]))),
                        new w.Rule("@" + a, b, !1, null, 0)
                      );
                    })),
                  ...
                  try {
                    var j,
                      k = [],
                      l = [
                        new w.joinSelectorVisitor(),
                        new w.processExtendsVisitor(),
                        new w.toCSSVisitor({ compress: Boolean(e.compress) }),
                      ],
                      m = this;
                    if (e.plugins)
            ...
            var p = function (b) {
              return (
                (b = l || b || F.imports.error),
                b ? (b instanceof t || (b = new t(b, a)), e(b)) : e(null, g)
              );
            };
            return a.processImports === !1
              ? p()
              : (new w.importVisitor(this.imports, p).run(g), void 0);
          },
          parsers: (G = {
            primary: function () {
            ...
            comment: function () {
              ...
              if ("/" === u.charAt(x))
                return "/" === u.charAt(x + 1)
                  ? new w.Comment(i(/^\/\/.*/), !0, x, a.currentFileInfo)
                  : ((b = i(/^\/\*(?:[^*]|\*+[^\/*])*\*+\/\n?/)),
            ...
            entities: {
              ...
              call: function () {
                ...
                if ((b = /^([\w-]+|%|progid:[\w\.]+)\(/.exec(D))) {
                  ...
                  if (
                    ((x += b.length),
                    "alpha" === c && ((e = G.alpha()), "undefined" != typeof e))
                  )
                    return e;
              ...
              assignment: function () {
                ...
                return (
                  (a = i(/^\w+(?=\s?=)/i)),
                  a && j("=")
                    ? ((b = G.entity()), b ? new w.Assignment(a, b) : void 0)
                    : void 0
                );
              },
              url: function () {
                ...
                if ("u" === u.charAt(x) && i(/^url\(/))
                  return (
                    ...
                    m(")"),
                    new w.URL(
                      null != b.value || b instanceof w.Variable
                        ? b
                        : new w.Anonymous(b),
                      a.currentFileInfo
                    )
              ...
              variable: function () {
                var b,
                  c = x;
                return "@" === u.charAt(x) && (b = i(/^@@?[\w-]+/))
                  ? new w.Variable(b, c, a.currentFileInfo)
                  : void 0;
              },
              variableCurly: function () {
                var b,
                  c = x;
                return "@" === u.charAt(x) && (b = i(/^@\{([\w-]+)\}/))
                  ? new w.Variable("@" + b[1], c, a.currentFileInfo)
                  : void 0;
              },
              color: function () {
                var a;
                return "#" === u.charAt(x) &&
                  (a = i(/^#([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3})/))
                  ? new w.Color(a[1])
                  : void 0;
              },
              dimension: function () {
                ...
                if (!(b > 57 || 43 > b || 47 === b || 44 == b))
                  return (
                    (a = i(/^([+-]?\d*\.?\d+)(%|[a-z]+)?/)),
                    a ? new w.Dimension(a[1], a[2]) : void 0
                  );
              },
              unicodeDescriptor: function () {
                var a;
                return (
                  (a = i(/^U\+[0-9a-fA-F?]+(\-[0-9a-fA-F?]+)?/)),
                  a ? new w.UnicodeDescriptor(a[0]) : void 0
                );
              },
              javascript: function () {
                var c,
                ...
                return (
                  ...
                  "`" === u.charAt(e)
                    ? (a.javascriptEnabled === b ||
                        a.javascriptEnabled ||
                        n("You are using JavaScript, which has been disabled."),
                      d && j("~"),
                      (c = i(/^`([^`]*)`/)),
                      c ? new w.JavaScript(c[1], x, d) : void 0)
                    : void 0
                );
              },
            },
            ...
            extend: function (a) {
              ...
              if (a ? i(/^&:extend\(/) : i(/^:extend\(/)) {
                do {
                  for (
                    d = null, b = null;
                    !(d = i(/^(all)(?=\s*(\)|,))/)) && (c = this.element());

                  )
                    b ? b.push(c) : (b = [c]);
                  (d = d && d[1]),
                    (f = new w.Extend(new w.Selector(b), d, g)),
                    e ? e.push(f) : (e = [f]);
                } while (j(","));
                return l(/^\)/), a && l(/^;/), e;
              }
            ...
            mixin: {
                ...
                if ("." === k || "#" === k) {
                  for (d(); ; ) {
                    if (
                      ...
                      break;
                    (c = new w.Element(g, f, x, a.currentFileInfo)),
                      b ? b.push(c) : (b = [c]),
                      (g = j(">"));
                  }
                  return (
                    j("(") && ((h = this.args(!0).args), m(")")),
                    G.important() && (l = !0),
                    b && (j(";") || p("}"))
                      ? new w.mixin.Call(b, h, n, a.currentFileInfo, l)
                      : (e(), void 0)
                  );
                }
              },
              args: function (a) {
                for (
                  ...
                  var r = null;
                  if (
                    (a ? 1 == g.value.length && (r = g.value[0]) : (r = g),
                    r && r instanceof w.Variable)
                  )
                    if (j(":"))
                      o.length > 0 &&
                        (b && n("Cannot mix ; and , as delimiter types"),
                        (c = !0)),
                        (f = l(h.expression)),
                        (e = d = r.name);
                    else {
                      if (!a && i(/^\.{3}/)) {
                        (m.variadic = !0),
                          j(";") && !b && (b = !0),
                          (b ? p : q).push({ name: g.name, variadic: !0 });
                        break;
                      }
                      a || ((d = e = r.name), (f = null));
                    }
                  f && o.push(f),
                    q.push({ name: e, value: f }),
                    j(",") ||
                      ((j(";") || b) &&
                        (c && n("Cannot mix ; and , as delimiter types"),
                        (b = !0),
                        o.length > 1 && (f = new w.Value(o)),
                        p.push({ name: d, value: f }),
                        (d = null),
                        (o = []),
                        (c = !1)));
                }
              ...
              definition: function () {
                ...
                if (
                  ...
                  if (
                    ...
                    j(")") || ((B = x), e()),
                    G.comments(),
                    i(/^when/) && (f = l(G.conditions, "expected condition")),
                    (c = G.block()))
                  )
            ...
            alpha: function () {
              ...
              if (i(/^\(opacity=/i))
                return (
                  (a = i(/^\d+/) || this.entities.variable()),
                  a ? (m(")"), new w.Alpha(a)) : void 0
                );
            },
            element: function () {
              var b, c, d;
              return (
                ...
                b ||
                  (j("(") &&
                    ...
                    j(")") &&
                    (b = new w.Paren(d))),
                b ? new w.Element(c, b, x, a.currentFileInfo) : void 0
              );
            },
            combinator: function () {
              var a = u.charAt(x);
            ...
            selector: function (b) {
              for (
                var c, d, e, f, g, h, i, j = J;
                ((b && (g = this.extend())) ||
                  (b && (h = j(/^when/))) ||
                  (f = this.element())) &&
                (h
                  ? (i = l(this.conditions, "expected condition"))
                  : i
                  ? n("CSS guard can only be used at the end of selector")
                  : g
                  ? d
                    ? d.push(g)
                    : (d = [g])
                  : (d && n("Extend can only be used at the end of selector"),
                    (e = u.charAt(x)),
                    c ? c.push(f) : (c = [f]),
                    (f = null)),
                "{" !== e && "}" !== e && ";" !== e && "," !== e && ")" !== e);
              ...
              return c
                ? new w.Selector(c, d, i, x, a.currentFileInfo)
                : (d &&
                    n(
            ...
            ruleset: function () {
              ...
              for (d(), a.dumpLineNumbers && (g = s(x, u, a)); ; ) {
                ...
                if ((b ? b.push(c) : (b = [c]), this.comments(), !j(",")))
                  break;
                c.condition &&
                  n("Guards are only currently allowed on a single selector."),
                  this.comments();
              }
              if (b && (f = this.block())) {
            ...
            rule: function (b) {
              ...
              if (
                ...
                if (
                  ((f =
                    !b && (a.compress || (c.charAt && "@" === c.charAt(0)))
            ...
            anonymousValue: function () {
              ...
              return (
                (a = /^([^@+\/'"*`(;{}-]*);/.exec(D)),
                a ? ((x += a[0].length - 1), new w.Anonymous(a[1])) : void 0
              );
            },
            import: function () {
              var b,
              ...
              return g &&
                ...
                ((c = this.mediaFeatures()), j(";"))
                ? ((c = c && new w.Value(c)),
                  new w.Import(b, c, h, f, a.currentFileInfo))
                : (e(), void 0);
            },
              ...
              do
                if ((b = d.keyword() || d.variable())) e.push(b);
                  ...
                  if (c && b)
                    e.push(
                      new w.Paren(
                        new w.Rule(c, b, null, null, x, a.currentFileInfo, !0)
                      )
                    );
                  else {
                    if (!b) return null;
            ...
            media: function () {
              var b, c, d, e;
              return (
                a.dumpLineNumbers && (e = s(x, u, a)),
                i(/^@media/) && ((b = this.mediaFeatures()), (c = this.block()))
                  ? ((d = new w.Media(c, b, x, a.currentFileInfo)),
              ...
              if ("@" === u.charAt(x)) {
                ...
                if ((d(), (b = i(/^@[a-z-]+/)))) {
                  ...
                  if (
                    ...
                    if ((f = this.block()))
                      return new w.Directive(b, f, x, a.currentFileInfo);
                  } else if (
                    ((c = l ? this.expression() : this.entity()), c && j(";"))
                  ) {
            ...
            sub: function () {
              var a, b;
              return j("(") && (a = this.addition())
                ? ((b = new w.Expression([a])), m(")"), (b.parens = !0), b)
                : void 0;
            },
              ...
              return (
                ...
                a
                  ? ((d = i(/^(?:>=|<=|=<|[<=>])/)),
                    ...
                    m(")"),
                    i(/^and/) ? new w.Condition("and", c, this.condition()) : c)
                  : void 0
              );
            },
            operand: function () {
              ...
              do
                (a = this.addition() || this.entity()),
                  a &&
                    (c.push(a),
                    o(/^\/[\/*]/) ||
                      ((b = j("/")), b && c.push(new w.Anonymous(b))));
              while (a);
    ...
    (function (a) {
      (a.Directive = function (b, c, d, e) {
        (this.name = b),
          Array.isArray(c)
            ? ((this.rules = [new a.Ruleset(null, c)]),
        ...
        (a.Directive.prototype = {
          ...
          accept: function (a) {
            this.rules && (this.rules = a.visitArray(this.rules)),
              this.value && (this.value = a.visit(this.value));
          },
          genCSS: function (b, c) {
              ...
              if ((c = b.frames[f].find(this.selector)).length > 0) {
                ...
                for (g in o)
                  if (
                    ((l = o[g]),
                    !l.matchIfDefault ||
                      l.matchIfDefaultValue == (1 == o.length))
                  )
                    try {
                      (d = l.mixin),
                        d instanceof a.mixin.Definition ||
      ...
      (a.Ruleset = function (a, b, c) {
        ...
        (a.Ruleset.prototype = {
          ...
          eval: function (b) {
            ...
            var h,
              i = this.rules ? this.rules.slice(0) : null,
              j = new a.Ruleset(c, i, this.strictImports);
            (j.originalRuleset = this),
              (j.root = this.root),
              (j.firstRoot = this.firstRoot),
              (j.allowImports = this.allowImports),
              this.debugInfo && (j.debugInfo = this.debugInfo);
            var k = b.frames;
            k.unshift(j);
            var l = b.selectors;
            l || (b.selectors = l = []),
              l.unshift(this.selectors),
              (j.root || j.allowImports || !j.strictImports) &&
                j.evalImports(b);
            var m = j.rules,
              n = m ? m.length : 0;
            for (e = 0; n > e; e++)
            ...
            for (e = 0; n > e; e++)
              m[e] instanceof a.mixin.Call &&
                ((i = m[e].eval(b).filter(function (b) {
                  return b instanceof a.Rule && b.variable
                    ? !j.variable(b.name)
                    : !0;
                })),
                m.splice.apply(m, [e, 1].concat(i)),
                (n += i.length - 1),
                (e += i.length - 1),
                j.resetCache());
            for (e = 0; n > e; e++)
              (h = m[e]),
                h instanceof a.mixin.Definition ||
                  (m[e] = h.eval ? h.eval(b) : h);
        ...
        (a.URL.prototype = {
          ...
          eval: function (b) {
            ...
            return (
              ...
              new a.URL(d, this.currentFileInfo, !0)
            );
          },
        });
    })(c("../tree")),
  ...
  var x = /^(file|chrome(-extension)?|resource|qrc|app):/.test(
    location.protocol
  );
  v.env =
    v.env ||
  ...
  if (
    ((v.logLevel = "undefined" != typeof v.logLevel ? v.logLevel : y.info),
    (v.async = v.async || !1),
    (v.fileAsync = v.fileAsync || !1),
    (v.poll = v.poll || (x ? 1e3 : 1500)),
    v.functions)
  )
  ...
  if (
    ((v.watch = function () {
      return (
        v.watchMode || ((v.env = "development"), u()), (this.watchMode = !0), !0
      );
    }),
    (v.unwatch = function () {
      return clearInterval(v.watchTimer), (this.watchMode = !1), !1;
    }),
    /!watch/.test(location.hash) && v.watch(),
    "development" != v.env)
  )
    try {
  ...
  for (var G = 0; G < F.length; G++)
    ("stylesheet/less" === F[G].rel ||
      (F[G].rel.match(/stylesheet/) && F[G].type.match(B))) &&
      v.sheets.push(F[G]);
  (v.modifyVars = function (a) {
        ...
        t(
          function (a, b, f, h, j) {
            return a
              ? i(a, h.href)
              : (j.local
                  ? d("loading " + h.href + " from cache.", y.info)
                  : (d("parsed " + h.href + " successfully.", y.info),
                    g(b.toCSS(v), h, j.lastModified)),
                d(
                  "css for " +
                    h.href +
                    " generated in " +
                ...
                0 === j.remaining &&
                  d("css generated in " + (new Date() - c) + "ms", y.info),
                (e = new Date()),
                void 0);
          },
          a,
    ...
    (v.refreshStyles = m),
    (v.Parser.fileLoader = r),
    v.refresh("development" === v.env),
