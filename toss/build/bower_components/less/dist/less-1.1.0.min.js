...
(function (a, b) {
      ...
      r(
        ...
        function (a, g) {
          if (
            ...
            q(l.css, b), c(null, b, { local: !0, remaining: f });
          else
            try {
              new d.Parser({
  ...
  typeof a == "undefined"
      ...
      return (l = {
        ...
        parse: function (d, g) {
          ...
          (c = f = k = i = 0),
            ...
            (h = new e.Ruleset([], s(this.parsers.primary))),
            (h.root = !0),
            (h.toCSS = (function (c) {
              var d, f, g;
              return function (g, h) {
                ...
                (g = g || {}),
                  typeof h == "object" &&
                    !Array.isArray(h) &&
                    ((h = Object.keys(h).map(function (a) {
                      var b = h[a];
        ...
        parsers: {
          ...
          entities: {
            ...
            literal: function () {
              return (
                s(this.entities.dimension) ||
                s(this.entities.color) ||
                s(this.entities.quoted)
              );
            },
            url: function () {
              var a;
              if (b.charAt(c) === "u" && !!s(/^url\(/)) {
                a =
                  s(this.entities.quoted) ||
                  s(this.entities.variable) ||
                  s(this.entities.dataURI) ||
                  s(/^[-\w%@$\/.&=:;#+?~]+/) ||
                  "";
            ...
            variable: function () {
              var a,
                d = c;
              if (b.charAt(c) === "@" && (a = s(/^@@?[\w-]+/)))
                return new e.Variable(a, d);
            },
            color: function () {
              var a;
              if (
                b.charAt(c) === "#" &&
                (a = s(/^#([a-fA-F0-9]{6}|[a-fA-F0-9]{3})/))
              )
            ...
            call: function () {
              ...
              if (i === "." || i === "#") {
                while (
                  ...
                  a.push(new e.Element(f, d)), (f = s(">"));
                s("(") && (g = s(this.entities.arguments)) && s(")");
                if (a.length > 0 && (s(";") || t("}")))
                  return new e.mixin.Call(a, g, h);
              }
            },
            definition: function () {
              var a,
              ...
              if (
                ...
                if (
                  ...
                  while (
                    (h =
                      s(this.entities.variable) ||
                      s(this.entities.literal) ||
                      s(this.entities.keyword))
                  ) {
                    if (h instanceof e.Variable)
                      if (s(":"))
                        if ((i = s(this.expression)))
                          d.push({ name: h.name, value: i });
          ...
          entity: function () {
            return (
              ...
              s(this.entities.variable) ||
              s(this.entities.url) ||
              s(this.entities.call) ||
              s(this.entities.keyword) ||
              s(this.entities.javascript) ||
              s(this.comment)
            );
          },
          end: function () {
          ...
          attribute: function () {
            var a = "",
              ...
              d;
            if (!!s("[")) {
              if ((b = s(/^[a-zA-Z-]+/) || s(this.entities.quoted)))
                (d = s(/^[|~*$^]?=/)) &&
                (c = s(this.entities.quoted) || s(/^[\w-]+/))
          ...
          ruleset: function () {
            ...
            if ((g = /^([.#: \w-]+)[\s\n]*\{/.exec(j[f])))
              (c += g[0].length - 1),
                (a = [new e.Selector([new e.Element(null, g[1])])]);
            else
          ...
          rule: function () {
            ...
            if (g !== "." && g !== "#" && g !== "&")
              if ((a = s(this.variable) || s(this.property))) {
                a.charAt(0) != "@" && (l = /^([^@+\/'"*`(;{}-]*);/.exec(j[f]))
                  ? ((c += l[0].length - 1), (d = new e.Anonymous(l[1])))
                  : a === "font"
                  ? (d = s(this.font))
                  : (d = s(this.value)),
                  (k = s(this.important));
          ...
          import: function () {
            ...
            if (
              s(/^@import\s+/) &&
              (a = s(this.entities.quoted) || s(this.entities.url)) &&
              s(";")
            )
              return new e.Import(a, o);
          },
          directive: function () {
            var a, d, f, g;
            if (b.charAt(c) === "@") {
            ...
            if ((a = s(this.multiplication))) {
              while (
                (f =
                  s(/^[-+]\s+/) ||
                  (b.charAt(c - 1) != " " && (s("+") || s("-")))) &&
                (d = s(this.multiplication))
              )
                g = new e.Operation(f, [g || a, d]);
              return g || a;
            }
          },
          operand: function () {
    ...
    (function (a) {
      ...
      a.functions = {
        ...
        round: function (b) {
          if (b instanceof a.Dimension)
            return new a.Dimension(Math.round(c(b)), b.unit);
      ...
      (a.Call = function (a, b) {
        ...
        (a.Call.prototype = {
          eval: function (b) {
            ...
            return this.name in a.functions
              ? a.functions[this.name].apply(a.functions, c)
              : new a.Anonymous(
                  this.name +
                    "(" +
                    c
    ...
    (function (a) {
      (a.Color = function (a, b) {
        Array.isArray(a)
          ...
          : a.length == 8
          ? ((this.alpha = parseInt(a.substring(0, 2), 16) / 255),
            (this.rgb = a
              .substr(2)
              .match(/.{2}/g)
              .map(function (a) {
      ...
      (a.Import = function (b, c) {
        ...
        (a.Import.prototype = {
          ...
          eval: function (b) {
            ...
            for (var d = 0; d < c.rules.length; d++)
              c.rules[d] instanceof a.Import &&
                Array.prototype.splice.apply(
                  c.rules,
                  [d, 1].concat(c.rules[d].eval(b))
                );
            return c.rules;
          },
        });
      ...
      (a.JavaScript = function (a, b, c) {
        ...
        (a.JavaScript.prototype = {
          ...
          eval: function (b) {
            ...
            for (var f in b.frames[0].variables())
              d[f.slice(1)] = {
                value: b.frames[0].variables()[f].value,
                toJS: function () {
            ...
            for (var e = 0; e < a.frames.length; e++)
              if ((b = a.frames[e].find(this.selector)).length > 0) {
                for (var f = 0; f < b.length; f++)
                  if (b[f].match(this.arguments, a))
                    try {
                      Array.prototype.push.apply(
                        c,
                        b[f].eval(a, this.arguments).rules
                      ),
                        (d = !0);
                    } catch (g) {
                      throw {
          ...
          eval: function (b, c) {
            ...
            for (var g = 0, h; g < this.params.length; g++)
              if (this.params[g].name)
                if ((h = (c && c[g]) || this.params[g].value))
                  d.rules.unshift(new a.Rule(this.params[g].name, h.eval(b)));
                else
                  throw {
                    message:
            ...
            for (
              var g = 0;
              g < Math.max(this.params.length, c && c.length);
              g++
            )
              f.push(c[g] || this.params[g].value);
            d.rules.unshift(new a.Rule("@arguments", new a.Expression(f)));
            return new a.Ruleset(null, this.rules.slice(0)).eval({
              frames: [this, d].concat(this.frames, b.frames),
            });
          },
          match: function (a, b) {
            var c = (a && a.length) || 0,
            ...
            for (var e = 0; e < d; e++)
              if (
                !this.params[e].name &&
                a[e].eval(b).toCSS() != this.params[e].value.eval(b).toCSS()
              )
                return !1;
            return !0;
          },
      ...
      (a.Ruleset = function (a, b) {
        ...
        (a.Ruleset.prototype = {
          eval: function (b) {
            ...
            for (var d = 0; d < c.rules.length; d++)
              c.rules[d] instanceof a.mixin.Definition &&
                (c.rules[d].frames = b.frames.slice(0));
            for (var d = 0; d < c.rules.length; d++)
              c.rules[d] instanceof a.mixin.Call &&
                Array.prototype.splice.apply(
                  c.rules,
                  [d, 1].concat(c.rules[d].eval(b))
                );
            for (var d = 0, e; d < c.rules.length; d++)
              (e = c.rules[d]),
                e instanceof a.mixin.Definition ||
                  (c.rules[d] = e.eval ? e.eval(b) : e);
            b.frames.shift();
            return c;
          },
          match: function (a) {
              ...
              if (b.length === 0)
                ...
                for (var j = 0; j < this.selectors.length; j++)
                  for (var k = 0; k < b.length; k++)
                    g.push(b[k].concat([this.selectors[j]]));
            for (var l = 0; l < this.rules.length; l++)
              (i = this.rules[l]),
  ...
  (d.refresh = function (a) {
    ...
    (b = c = new Date()),
      n(function (a, d, e) {
        e.local
          ? u("loading " + d.href + " from cache.")
          : (u("parsed " + d.href + " successfully."),
            q(a.toCSS(), d, e.lastModified)),
          u("css for " + d.href + " generated in " + (new Date() - c) + "ms"),
          e.remaining === 0 && u("css generated in " + (new Date() - b) + "ms"),
          (c = new Date());
      }, a),
      m();
  }),
