...
(function (a, b) {
      ...
      q(
        ...
        function (a, g) {
          if (
            ...
            p(l.css, b), c(null, b, { local: !0, remaining: f });
          else
            try {
              new d.Parser({
      ...
      function s(a) {
        ...
        if (d) {
          ...
          return (
            ...
            typeof d == "string" ? d : d.length === 1 ? d[0] : d
          );
        }
      }
      function t(a) {
        ...
        (l = {
          ...
          parsers: {
            ...
            entities: {
              ...
              keyword: function () {
                var a;
                if ((a = s(/^[_A-Za-z-][_A-Za-z0-9-]*/)))
                  return new e.Keyword(a);
              },
              call: function () {
                var a,
                  b,
            ...
            shorthand: function () {
              var a, b;
              if (!t(/^[@\w.%-]+\/[@\w.-]+/)) return;
              if ((a = s(this.entity)) && s("/") && (b = s(this.entity)))
            ...
            mixin: {
              call: function () {
                ...
                while (
                  ...
                  a.push(new e.Element(f, d, c)), (f = s(">"));
            ...
            element: function () {
              ...
              if (d.value && d.value.charAt(0) === "&")
                return new e.Element(d, null, c);
            },
            combinator: function () {
              var a,
                d = b.charAt(c);
            ...
            ruleset: function () {
              ...
              if (a.length > 0 && (d = s(this.block)))
                return new e.Ruleset(a, d);
              (i = c), q();
            },
            rule: function () {
              var a,
            ...
            directive: function () {
              ...
              if (
                (a = s(/^@media|@page/) || s(/^@(?:-webkit-|-moz-)?keyframes/))
              ) {
                g = (s(/^[^{]+/) || "").trim();
  ...
  if (d.mode === "browser" || d.mode === "rhino")
    d.Parser.importer = function (a, b, c, d) {
      a.charAt(0) !== "/" && b.length > 0 && (a = b[0] + a),
        n({ href: a, title: a, type: d.mime }, c, !0);
    };
  (function (a) {
    function b(b) {
                  ...
                  if (b[g].match(c, a))
                    try {
                      Array.prototype.push.apply(
                        d,
                        b[g].eval(a, this.arguments).rules
                      ),
                        (e = !0);
                    } catch (h) {
                      throw {
        ...
        (a.mixin.Definition.prototype = {
          ...
          eval: function (b, c) {
            ...
            return (
              ...
              new a.Ruleset(null, this.rules.slice(0)).eval({
    ...
    (function (a) {
      (a.URL = function (a, b) {
        a.data
          ? (this.attrs = a)
          : (d.mode === "browser" &&
              !/^(?:https?:\/\/|file:\/\/|data:|\/)/.test(a.value) &&
              b.length > 0 &&
              (a.value =
                b[0] +
                (a.value.charAt(0) === "/" ? a.value.slice(1) : a.value)),
            (this.value = a),
            (this.paths = b));
      }),
        (a.URL.prototype = {
          ...
          eval: function (b) {
            return this.attrs
              ? this
              : new a.URL(this.value.eval(b), this.paths);
          },
        });
    })(c("../tree")),
    (function (a) {
  ...
  (d.refresh = function (a) {
    ...
    (b = c = new Date()),
      m(function (a, d, e) {
        e.local
          ? t("loading " + d.href + " from cache.")
          : (t("parsed " + d.href + " successfully."),
            p(a.toCSS(), d, e.lastModified)),
          t("css for " + d.href + " generated in " + (new Date() - c) + "ms"),
          e.remaining === 0 && t("css generated in " + (new Date() - b) + "ms"),
          (c = new Date());
      }, a),
      l();
  }),
