...
(function (window, undefined) {
        ...
        element: function () {
          ...
          if (!e) {
            if (
              $("(") &&
              (v =
                $(this.entities.variableCurly) || $(this.entities.variable)) &&
              $(")")
            ) {
              e = new tree.Paren(v);
            }
  ...
  if (less.mode === "browser" || less.mode === "rhino") {
    ...
    less.Parser.importer = function (path, paths, callback, env) {
      ...
      loadStyleSheet(
        { href: path, title: path, type: env.mime, contents: env.contents },
        function (e) {
  ...
  (function (tree) {
    ...
    tree.Import = function (path, imports, features, once, index) {
      ...
      if (path instanceof tree.Quoted) {
        this.path = /\.(le?|c)ss(\?.*)?$/.test(path.value)
          ? path.value
          : path.value + ".less";
      } else {
              ...
              if (mixins[m].match(args, env)) {
                try {
                  Array.prototype.push.apply(
                    rules,
                    mixins[m].eval(env, this.arguments, this.important).rules
                  );
                  match = true;
                } catch (e) {
                  throw {
    ...
    tree.URL.prototype = {
      ...
      eval: function (ctx) {
        ...
        if (
          ...
          val.value =
            this.paths[0] +
            (val.value.charAt(0) === "/" ? val.value.slice(1) : val.value);
        }
