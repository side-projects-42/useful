define("scalaish/util/Try", [
  ...
  var T = __dependency3__.T;
  var __result = __dependency4__.__result;
  ...
  var UnsupportedOperationException =
    __dependency6__.UnsupportedOperationException;
        ...
        return p.call(context, this.value)
          ...
          : Failure(
              new NoSuchElementException(
                "Predicate does not hold for " + this.value
              )
            );
      } catch (e) {
        // TODO: NonFatal
  ...
  FailureImpl.prototype = _.extend(Object.create(TryImpl.prototype), {
    ...
    recover: function (rescueException, context) {
      try {
        return true /* TODO */
          ? Try(rescueException.bind(context, this.exception))
          : this;
      } catch (e) {
        // TODO: NonFatal
        return Failure(e);
  ...
  Try.unapply = function (t) {
    return t.isSuccess ? Success.unapply(t) : Failure.unapply(t);
  };
