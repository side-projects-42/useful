        ...
        (m = {
          ...
          parse: function (h, i) {
            ...
            (f = g = l = j = 0),
              ...
              (m = new e.Ruleset([], t(this.parsers.primary))),
              (m.root = !0),
              (m.toCSS = (function (f) {
                var g, h, i;
                return function (i, j) {
                  ...
                  (i = i || {}),
                    typeof j == "object" &&
                      !Array.isArray(j) &&
                      ((j = Object.keys(j).map(function (a) {
                        var b = j[a];
                        return (
                  ...
                  try {
                    ...
                    throw {
                      ...
                      filename: a.filename,
                      index: m.index,
                      line: typeof g == "number" ? g + 1 : null,
                      callLine: m.call && p(m.call) + 1,
                      callExtract: h[p(m.call)],
                      stack: m.stack,
                      column: o,
                      extract: [h[g - 1], h[g], h[g + 1]],
                    };
                  }
                  return i.yuicompress && d.mode === "node"
                    ? c("./cssmin").compressor.cssmin(l)
                    : i.compress
                    ? l.replace(/(\s)+/g, "$1")
                    : l;
                };
            ...
            if (f < b.length - 1) {
              ...
              w = {
                name: "ParseError",
                message: "Syntax Error on line " + r,
                index: f,
                filename: a.filename,
                line: r,
                column: y,
          ...
          parsers: {
            ...
            mixin: {
              call: function () {
                ...
                while (
                  ...
                  a.push(new e.Element(d, c, f)), (d = t(">"));
            ...
            ruleset: function () {
              ...
              if (a.length > 0 && (c = t(this.block)))
                return new e.Ruleset(a, c);
              (j = f), r();
            },
            rule: function () {
              var a,
