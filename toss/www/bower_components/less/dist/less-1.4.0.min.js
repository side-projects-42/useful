 ...
 */ (function (e, t) {
        ...
        (n.filename = document.location.href.replace(/#.*$/, "")),
          new r.Parser(n).parse(e[t].innerHTML || "", function (n, i) {
            ...
            var s = i.toCSS(r),
              o = e[t];
            (o.type = "text/css"),
              o.styleSheet ? (o.styleSheet.cssText = s) : (o.innerHTML = s);
          });
      }
  }
  function g(e, t) {
  ...
  function w(t, n, i, s) {
    ...
    t instanceof r.tree.parseEnv
      ...
      h.relativeUrls &&
        (r.rootpath
          ? (p.rootpath = b(r.rootpath + y(o.path, p.entryPath)).path)
          : (p.rootpath = o.path)),
      x(
        u,
        t.type,
        function (e, a) {
          ...
          if (
            ...
            c &&
            a &&
            new Date(a).valueOf() === new Date(c.timestamp).valueOf()
          )
                ...
                new r.Parser(h).parse(e, function (r, i) {
                  ...
                  try {
                    n(
                      ...
                      e,
                      t,
                      { local: !1, lastModified: a, remaining: s },
                      u
                    ),
                      h.currentFileInfo.rootFilename === u &&
                        N(
                          document.getElementById("less-error-message:" + E(u))
                        );
                  } catch (r) {
                    n(r, null, null, t);
                  }
        ...
        function (e, r) {
          n(
            { type: "File", message: "'" + r + "' wasn't found (" + e + ")" },
            null,
            null,
            t
          );
  ...
  function S(e, t, n) {
    ...
    u.setAttribute("type", "text/css"),
      t.media && u.setAttribute("media", t.media),
      (u.id = i);
    if (u.styleSheet)
      try {
    ...
    if (s == null || o === !1) {
      ...
      (c || document.getElementsByTagName("head")[0]).parentNode.insertBefore(
        u,
        c
      );
    }
  ...
  {}.toString.call(environment) === "[object Environment]"
    ...
    (r.Parser = function (t) {
      ...
      function N(e, t) {
        return e.filename &&
          t.currentFileInfo.filename &&
          e.filename !== t.currentFileInfo.filename
      ...
      return (
        ...
        (p = {
          ...
          parse: function (e, a) {
            ...
            try {
              (f = new i.Ruleset([], w(this.parsers.primary))),
                (f.root = !0),
                (f.firstRoot = !0);
            } catch (x) {
              return a(new L(x, t));
            ...
            f.toCSS = (function (e) {
              ...
              return function (s, o) {
                ...
                try {
                  var f = e.call(this, a);
                  new i.joinSelectorVisitor().run(f),
                    new i.processExtendsVisitor().run(f);
                  var l = f.toCSS({
            ...
            var C = function (e) {
              (e = S || e || p.imports.error),
                e ? (e instanceof L || (e = new L(e, t)), a(e)) : a(null, f);
            };
            t.processImports !== !1
              ? new i.importVisitor(this.imports, C).run(f)
              : C();
          },
          parsers: {
            primary: function () {
            ...
            entities: {
              ...
              arguments: function () {
                var e = [],
                  t;
                while (
                  (t = w(this.entities.assignment) || w(this.expression))
                ) {
                  e.push(t);
                  if (!w(",")) break;
                }
              ...
              args: function (e) {
                ...
                for (;;) {
                  ...
                  if (d && d instanceof i.Variable)
                    if (w(":"))
                      t.length > 0 &&
                        (r && x("Cannot mix ; and , as delimiter types"),
                        (a = !0)),
                        (c = S(this.expression)),
                        (l = f = d.name);
                    else {
                      if (!e && w(/^\.{3}/)) {
                        (p.variadic = !0),
                          w(";") && !r && (r = !0),
                          (r ? n : u).push({ name: h.name, variadic: !0 });
                        break;
                      }
                      e || ((f = l = d.name), (c = null));
                    }
              ...
              definition: function () {
                ...
                if (
                  ...
                  (t = h.args),
                    ...
                    w(this.comment),
                    w(/^when/) &&
                      (f = S(this.conditions, "expected condition")),
                    (r = w(this.block));
            ...
            selector: function () {
              ...
              while ((a = w(this.extend)) || (t = w(this.element))) {
                a
                  ? f.push.apply(f, a)
                  : (f.length &&
                      x("Extend can only be used at the end of selector"),
                    (r = s.charAt(o)),
                    n.push(t),
                    (t = null));
                if (
            ...
            attribute: function () {
              var e = "",
                ...
                r;
              if (!w("[")) return;
              (t = w(this.entities.variableCurly)) ||
                (t = S(/^(?:[_A-Za-z0-9-\*]*\|)?(?:[_A-Za-z0-9-]|\\.)+/));
              if ((r = w(/^[|~*$^]?=/)))
                n =
                  w(this.entities.quoted) ||
                  w(/^[\w-]+/) ||
            ...
            anonymousValue: function () {
              if ((match = /^([^@+\/'"*`(;{}-]*);/.exec(c[u])))
                return (o += match[0].length - 1), new i.Anonymous(match[1]);
            },
            import: function () {
              var e,
                n,
              ...
              if (s && (e = w(this.entities.quoted) || w(this.entities.url))) {
                ...
                if (w(";"))
                  return (
                    (n = n && new i.Value(n)),
                    new i.Import(e, n, u, r, t.currentFileInfo)
                  );
              }
              g();
            },
              ...
              do
                if ((e = w(this.entities.keyword))) r.push(e);
                  ...
                  if (n && e)
                    r.push(
                      new i.Paren(
                        new i.Rule(n, e, null, o, t.currentFileInfo, !0)
                      )
                    );
                  else {
                    if (!e) return null;
            ...
            directive: function () {
              ...
              if (c) {
                ...
                (n = p ? w(this.expression) : w(this.entity)) &&
                w(";")
              ) {
            ...
            sub: function () {
              ...
              if (w("("))
                if ((e = w(this.addition)))
                  return (
                    (t = new i.Expression([e])), S(")"), (t.parens = !0), t
                  );
            },
            ...
            expression: function () {
              ...
              while ((e = w(this.addition) || w(this.entity)))
                n.push(e),
                  !T(/^\/[\/*]/) && (t = w("/")) && n.push(new i.Anonymous(t));
  ...
  (function (r) {
    ...
    function a(e, t) {
      return e instanceof r.Dimension && e.unit.is("%")
    ...
    (r.functions = {
      ...
      contrast: function (e, t, n, r) {
        ...
        return (
          typeof r == "undefined" ? (r = 0.43) : (r = f(r)),
      ...
      isunit: function (e, t) {
        return e instanceof r.Dimension && e.unit.is(t.value || t)
          ? r.True
          : r.False;
      },
      _isa: function (e, t) {
      ...
      (e.Call = function (e, t, n, r) {
        ...
        (e.Call.prototype = {
          ...
          eval: function (t) {
            ...
            if (r in e.functions)
              try {
                (s = new e.functionCall(t, this.currentFileInfo)),
                  (i = s[r].apply(s, n));
                if (i != null) return i;
              } catch (o) {
                throw {
    ...
    (function (e) {
      (e.Dimension = function (n, r) {
        (this.value = parseFloat(n)),
          (this.unit = r && r instanceof e.Unit ? r : new e.Unit(r ? [r] : t));
      }),
          ...
          operate: function (t, n, r) {
            ...
            if (n === "+" || n === "-") {
              if (s.numerator.length === 0 && s.denominator.length === 0)
                (s.numerator = r.unit.numerator.slice(0)),
                  (s.denominator = r.unit.denominator.slice(0));
              else if (
                r.unit.numerator.length != 0 ||
                s.denominator.length != 0
              ) {
          ...
          compare: function (t) {
            if (t instanceof e.Dimension) {
              ...
              return s > i
                ...
                : s < i
                ? 1
                : !r.unit.isEmpty() && n.unit.compare(r.unit) !== 0
                ? -1
                : 0;
            }
            return -1;
          ...
          convertTo: function (t) {
            ...
            if (typeof t == "string") {
              for (i in e.UnitConversions)
                e.UnitConversions[i].hasOwnProperty(t) &&
                  ((f = {}), (f[i] = t));
              t = f;
            }
            for (s in t)
    ...
    (function (e) {
      (e.mixin = {}),
        ...
        (e.mixin.Call.prototype = {
          ...
          accept: function (e) {
            (this.selector = e.visit(this.selector)),
              (this.arguments = e.visit(this.arguments));
          },
          eval: function (t) {
            var n,
              r,
          ...
          eval: function (t, n, r) {
            ...
            return (
              ...
              (l = new e.Ruleset(null, a).eval(
                new e.evalEnv(t, [this, o].concat(s))
              )),
              ...
              !this.condition.eval(
                new e.evalEnv(
                  ...
                  [
                    this.evalParams(
                      n,
                      new e.evalEnv(n, this.frames.concat(n.frames)),
                      t,
                      []
                    ),
                  ].concat(n.frames)
        ...
        (e.Rule.prototype = {
          ...
          toCSS: function (e) {
            ...
            try {
              ...
              throw (
                ((t.index = this.index),
                (t.filename = this.currentFileInfo.filename),
                t)
              );
            }
          },
    ...
    (function (e) {
      (e.Ruleset = function (e, t, n) {
        ...
        (e.Ruleset.prototype = {
          type: "Ruleset",
          accept: function (e) {
            (this.selectors = e.visit(this.selectors)),
              (this.rules = e.visit(this.rules));
          },
          eval: function (t) {
            var n =
            ...
            for (var s = 0; s < r.rules.length; s++)
              r.rules[s] instanceof e.mixin.Call &&
                ((i = r.rules[s].eval(t).filter(function (t) {
                  return t instanceof e.Rule && t.variable
                    ? !r.variable(t.name)
                    : !0;
                })),
          ...
          toCSS: function (t) {
            ...
            for (var f = 0; f < this.rules.length; f++) {
              ...
              if (a.rules || a instanceof e.Media) s.push(a.toCSS(t));
                ...
                a.silent ||
                  (this.root ? s.push(a.toCSS(t)) : r.push(a.toCSS(t)));
                ...
                if (this.firstRoot && a instanceof e.Rule)
                  throw {
                    ...
                    index: a.index,
                    filename: a.currentFileInfo
                      ? a.currentFileInfo.filename
                      : null,
                  };
                r.push(a.toCSS(t));
            ...
            t.compress &&
              ...
              ((a = r[r.length - 1]),
              a.charAt(a.length - 1) === ";" &&
                (r[r.length - 1] = a.substring(0, a.length - 1))),
              (s = s.join(""));
    ...
    (function (e) {
      (e.Selector = function (e, t) {
        ...
        (e.Selector.prototype = {
          type: "Selector",
          accept: function (e) {
            (this.elements = e.visit(this.elements)),
              (this.extendList = e.visit(this.extendList));
          },
          match: function (e) {
            var t = this.elements,
              n = t.length,
      ...
      (e.debugInfo = function (t, n) {
        ...
        (e.debugInfo.asMediaQuery = function (e) {
          return (
            ...
            ("file://" + e.debugInfo.fileName).replace(
              /([.:/\\])/g,
              function (e) {
                return e == "\\" && (e = "/"), "\\" + e;
              }
          ...
          visitImport: function (t, n) {
            ...
            if (!t.css) {
              try {
                ...
                s.filename ||
                  ((s.index = t.index),
                  (s.filename = t.currentFileInfo.filename)),
                  (t.css = !0),
                  (t.error = s);
              }
              if (i && !i.css) {
                ...
                this._importer.push(
                  ...
                  function (n, i, s) {
                    n &&
                      !n.filename &&
                      ((n.index = t.index),
                      (n.filename = t.currentFileInfo.filename)),
                      s && !t.options.multiple && (t.skip = s);
                    var u = function (e) {
                      r.importCount--,
                        r.importCount === 0 && r.isFinished && r._finish(e);
                    };
                    i
                      ? ((t.root = i),
                        new e.importVisitor(r._importer, u, o).run(i))
                      : u();
                  }
                );
              }
        ...
        (e.joinSelectorVisitor.prototype = {
          ...
          visitRuleset: function (e, t) {
            ...
            this.contexts.push(r),
              e.root || (e.joinSelectors(r, n, e.selectors), (e.paths = r));
          },
          visitRulesetOut: function (e) {
        ...
        (e.processExtendsVisitor.prototype = {
          run: function (t) {
            ...
            return (
              n.run(t),
              n.foundExtends
                ? ((t.allExtends = t.allExtends.concat(
                    this.doExtendChaining(t.allExtends, t.allExtends)
                  )),
          ...
          doExtendChaining: function (t, n, r) {
                  ...
                  o.length &&
                    c.selfSelectors.forEach(function (t) {
                      (a = f.extendSelector(o, l, t)),
                        (newExtend = new e.Extend(h.selector, h.option, 0)),
                        (newExtend.selfSelectors = a),
                        (a[a.length - 1].extendList = [newExtend]),
                        u.push(newExtend),
                        (newExtend.ruleset = h.ruleset),
                        (newExtend.parents = [h, c]),
                        h.firstExtendOnThisSelectorPath &&
                          ((newExtend.firstExtendOnThisSelectorPath = !0),
            ...
            if (u.length) {
              ...
              if (r > 100) {
                ...
                try {
                  (p = u[0].selfSelectors[0].toCSS()),
                    (d = u[0].selector.toCSS());
                } catch (v) {}
                throw {
                  message:
            ...
            for (i = 0; i < s.length; i++)
              for (r = 0; r < e.paths.length; r++) {
                ...
                if (selectorPath[selectorPath.length - 1].extendList.length)
                  continue;
                (n = this.findMatch(s[i], selectorPath)),
                  n.length &&
                ...
                for (u = 0; u < l.length; u++)
                  (c = l[u]),
                    ...
                    c &&
                      ...
                      c.finished &&
                        !e.allowAfter &&
                        (i + 1 < r.elements.length || n + 1 < t.length) &&
                        (c = null)),
                    c
                      ? c.finished &&
                        ((c.length = f.length),
          ...
          extendSelector: function (t, n, r) {
            ...
            for (u = 0; u < t.length; u++)
              (match = t[u]),
                ...
                match.pathIndex > i &&
                  s > 0 &&
                  ((o[o.length - 1].elements = o[o.length - 1].elements.concat(
                    n[i].elements.slice(s)
                  )),
                  (s = 0),
                  i++),
                (o = o.concat(n.slice(i, match.pathIndex))),
                o.push(
                  new e.Selector(
                    a.elements
                      .slice(s, match.index)
                ...
                (i = match.endPathIndex),
                (s = match.endPathElementIndex),
      ...
      (t = n = new Date()),
        g(function (e, i, s, o, u) {
          ...
          u.local
            ...
            : (C("parsed " + o.href + " successfully."),
              S(i.toCSS(r), o, u.lastModified)),
