      ...
      (a.Rule = function (b, c, d, e, f, g, h) {
        ...
        (a.Rule.prototype = {
          ...
          eval: function (c) {
            ...
            "string" != typeof e &&
              (e =
                1 === e.length && e[0] instanceof a.Keyword
                  ? e[0].value
                  : b(c, e)),
      ...
      (a.Ruleset = function (a, b, c) {
        ...
        (a.Ruleset.prototype = {
          ...
          eval: function (b) {
            ...
            var h,
              i,
              j = this.rules ? this.rules.slice(0) : null,
              k = new a.Ruleset(c, j, this.strictImports);
            (k.originalRuleset = this),
              (k.root = this.root),
              (k.firstRoot = this.firstRoot),
              (k.allowImports = this.allowImports),
              this.debugInfo && (k.debugInfo = this.debugInfo);
            var l = b.frames;
            l.unshift(k);
            var m = b.selectors;
            m || (b.selectors = m = []),
              m.unshift(this.selectors),
              (k.root || k.allowImports || !k.strictImports) &&
                k.evalImports(b);
            var n = k.rules,
              o = n ? n.length : 0;
            for (e = 0; o > e; e++)
            ...
            for (e = 0; o > e; e++)
              n[e] instanceof a.mixin.Call &&
                ((j = n[e].eval(b).filter(function (b) {
                  return b instanceof a.Rule && b.variable
                    ? !k.variable(b.name)
                    : !0;
                })),
                n.splice.apply(n, [e, 1].concat(j)),
                (o += j.length - 1),
                (e += j.length - 1),
                k.resetCache());
            for (e = 0; e < n.length; e++)
              if (
                ...
                !(h instanceof a.mixin.Definition) &&
                  ((n[e] = h = h.eval ? h.eval(b) : h),
                  h instanceof a.Ruleset &&
                    h.selectors &&
                ...
                for (var q = 0; q < h.rules.length; q++)
                  (i = h.rules[q]),
                    (i instanceof a.Rule && i.variable) || n.splice(++e, 0, i);
              }
