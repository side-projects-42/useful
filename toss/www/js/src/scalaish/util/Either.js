define("scalaish/util/Either", [
  ...
  EitherImpl.prototype = _.extend(Object.create(Any.prototype), {
    ...
    merge: function () {
      return this.match().case(Left, pipe).case(Right, pipe).get();
    },
     ...
     */
    swap: function () {
      return this.match().case(Left, Right).case(Right, Left).get();
    },
     ...
     */
    joinRight: function () {
      return this.match().case(Left, Left).case(Right, pipe).get();
    },
     ...
     */
    joinLeft: function () {
      return this.match().case(Left, pipe).case(Right, Right).get();
    },
  ...
  LeftProjectionImpl.prototype = _.extend(Object.create(Any.prototype), {
    ...
    get: function () {
      return this.e
        ...
        .case(
          Right,
          throwNoSuchElementEx.bind(undefined, "Either.left.value on Right")
        )
        .get();
    },

    forEach: function (f, context) {
      this.e.match().case(Left, f, context).case(Right, noOp);
    },
    ...
    flatMap: function (f, context) {
      return this.e.match().case(Left, f, context).case(Right, Right).get();
    },
  ...
  RightProjectionImpl.prototype = _.extend(Object.create(Any.prototype), {
    ...
    get: function () {
      return this.e
        ...
        .case(
          Left,
          throwNoSuchElementEx.bind(undefined, "Either.right.value on Left")
        )
        .case(Right, pipe)
        .get();
    },
    ...
    forEach: function (f, context) {
      this.e.match().case(Left, noOp).case(Right, f, context);
    },
    ...
    flatMap: function (f, context) {
      return this.e.match().case(Left, Left).case(Right, f, context).get();
    },
