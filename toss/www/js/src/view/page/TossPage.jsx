...
define([
  ...
  return React.createClass({
    ...
    render: function () {
      var textNumber =
        this.props.num === 2 ? T("Toss", COIN) : T("Roll", NUMBER);

      var items = _.range(1, this.props.num + 1).map(function (num, j) {
        var content =
          this.props.num === 2 && num === 2 ? (
      ...
      var footer = (
        <footer className="item-btn">
          <a
            className={"item-btn rest inv shade-" + (this.props.num - 1)}
