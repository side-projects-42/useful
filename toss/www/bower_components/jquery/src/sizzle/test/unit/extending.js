...
test("custom pseudos", function () {
  ...
  Sizzle.selectors.filters.aristotlean = Sizzle.selectors.createPseudo(
    function () {
  ...
  t("Custom element filter", "#foo :aristotlean", [
    "sndp",
    "en",
    "yahoo",
    "sap",
  ...
  Sizzle.selectors.filters.endswith = Sizzle.selectors.createPseudo(function (
    text
  ) {
    return function (elem) {
  ...
  Sizzle.selectors.setFilters.second = Sizzle.selectors.createPseudo(
    function () {
  ...
  Sizzle.selectors.setFilters.slice = Sizzle.selectors.createPseudo(function (
    argument
  ) {
...
test("backwards-compatible custom pseudos", function () {
  ...
  t("Custom element filter with argument", "a:icontains(THIS BLOG ENTRY)", [
    "simon1",
  ]);
...
test("custom attribute getters", function () {
  ...
  deepEqual(
    Sizzle(selector, createWithFriesXML()),
    [],
    "Custom attrHandle (preferred document)"
  );
