...
test("element", function () {
  ...
  t("Checking sort order", "h2:first, h1:first", [
    "qunit-header",
    "qunit-banner",
  ]);
  ...
  deepEqual(
    Sizzle("em + :not(:has(*)):not(:empty), foo", siblingTest),
    [siblingNext],
  ...
  q("qunit-fixture")[0].appendChild(document.createElement("toString")).id =
    "toString";
...
test("id", function () {
  ...
  deepEqual(
    Sizzle("> span", Sizzle("#fiddle\\\\Foo")[0]),
    q(["fiddleSpan"]),
  ...
  equal(
    Sizzle("div > div #tName1")[0].id,
    Sizzle("#tName1-span")[0].parentNode.id,
    "Ending with ID"
  );
...
test("class", function () {
  ...
  ok(
    !Sizzle.matchesSelector(div.firstChild, ".null div"),
    ".null does not match an element with no class"
  );
  div.className = "null";
  ok(
  ...
  ok(
    !Sizzle.matchesSelector(window, ".foo"),
    "testing class on window doesn't error"
  );
...
test("child and adjacent", function () {
  ...
  equal(
    Sizzle("#listWithTabIndex li:eq(2) ~ li").length,
    1,
  ...
  deepEqual(
    Sizzle("> :first", nothiddendiv),
    q("nothiddendivchild"),
    "Verify child context positional selector"
  );
  deepEqual(
    Sizzle("> :eq(0)", nothiddendiv),
    q("nothiddendivchild"),
    "Verify child context positional selector"
  );
  deepEqual(
...
test("attributes", function () {
  ...
  document
    .getElementById("attrbad_unicode")
    .setAttribute("data-attr", "\uD834\uDF06A");
...
test("pseudo - nth-child", function () {
  ...
  t("Nth-child (case-insensitive)", "#form select:first option:NTH-child(3)", [
    "option1c",
  ]);
  ...
  t("Nth-child(0n+3)", "#form select:first option:nth-child(0n+3)", [
    "option1c",
  ]);
  ...
  t("Nth-child(1n)", "#form select:first option:nth-child(1n)", [
    "option1a",
    "option1b",
    "option1c",
    "option1d",
  ]);
  t("Nth-child(n)", "#form select:first option:nth-child(n)", [
    "option1a",
    "option1b",
    "option1c",
    "option1d",
  ]);
  t("Nth-child(even)", "#form select:first option:nth-child(even)", [
    "option1b",
    "option1d",
  ]);
  t("Nth-child(odd)", "#form select:first option:nth-child(odd)", [
    "option1a",
    "option1c",
  ]);
  t("Nth-child(2n)", "#form select:first option:nth-child(2n)", [
    "option1b",
    "option1d",
  ]);
  t("Nth-child(2n+1)", "#form select:first option:nth-child(2n+1)", [
    "option1a",
    "option1c",
  ]);
  t("Nth-child(2n + 1)", "#form select:first option:nth-child(2n + 1)", [
  ...
  t("Nth-child(3n+1)", "#form select:first option:nth-child(3n+1)", [
    "option1a",
    "option1d",
  ]);
  t("Nth-child(3n+2)", "#form select:first option:nth-child(3n+2)", [
    "option1b",
  ]);
  t("Nth-child(3n+3)", "#form select:first option:nth-child(3n+3)", [
    "option1c",
  ]);
  t("Nth-child(3n-1)", "#form select:first option:nth-child(3n-1)", [
    "option1b",
  ...
  t("Nth-child(3n+0)", "#form select:first option:nth-child(3n+0)", [
    "option1c",
  ]);
  t("Nth-child(-1n+3)", "#form select:first option:nth-child(-1n+3)", [
    "option1a",
    "option1b",
    "option1c",
  ]);
  t("Nth-child(-n+3)", "#form select:first option:nth-child(-n+3)", [
    "option1a",
    "option1b",
    "option1c",
  ]);
...
test("pseudo - nth-last-child", function () {
  ...
  t(
    ...
    "#form select:first option:NTH-last-child(3)",
    ["option1b"]
  );
  ...
  t("Nth-last-child(3)", "#form select:first *:nth-last-child(3)", [
    "option1b",
  ]);
  t("Nth-last-child(3)", "#form select:first option:nth-last-child(3)", [
    "option1b",
  ]);
  t("Nth-last-child(0n+3)", "#form select:first option:nth-last-child(0n+3)", [
    "option1b",
  ]);
  ...
  t("Nth-last-child(even)", "#form select:first option:nth-last-child(even)", [
    "option1a",
    "option1c",
  ]);
  t("Nth-last-child(odd)", "#form select:first option:nth-last-child(odd)", [
    "option1b",
    "option1d",
  ]);
  t("Nth-last-child(2n)", "#form select:first option:nth-last-child(2n)", [
    "option1a",
    "option1c",
  ]);
  t("Nth-last-child(2n+1)", "#form select:first option:nth-last-child(2n+1)", [
    "option1b",
    "option1d",
  ]);
  t(
    "Nth-last-child(2n + 1)",
    "#form select:first option:nth-last-child(2n + 1)",
    ["option1b", "option1d"]
  );
  t(
    "Nth-last-child(+2n + 1)",
  ...
  t("Nth-last-child(3n)", "#form select:first option:nth-last-child(3n)", [
    "option1b",
  ]);
  t("Nth-last-child(3n+1)", "#form select:first option:nth-last-child(3n+1)", [
    "option1a",
    "option1d",
  ]);
  t("Nth-last-child(3n+2)", "#form select:first option:nth-last-child(3n+2)", [
    "option1c",
  ]);
  t("Nth-last-child(3n+3)", "#form select:first option:nth-last-child(3n+3)", [
    "option1b",
  ]);
  t("Nth-last-child(3n-1)", "#form select:first option:nth-last-child(3n-1)", [
    "option1c",
  ...
  t("Nth-last-child(3n+0)", "#form select:first option:nth-last-child(3n+0)", [
    "option1b",
  ]);
  t(
    "Nth-last-child(-1n+3)",
    "#form select:first option:nth-last-child(-1n+3)",
    ["option1b", "option1c", "option1d"]
  );
  t("Nth-last-child(-n+3)", "#form select:first option:nth-last-child(-n+3)", [
    "option1b",
    "option1c",
    "option1d",
  ]);
...
test("pseudo - misc", function () {
  ...
  ok(
    ...
    ":focus doesn't match tabIndex div"
  );
  document.body.removeChild(tmp);
...
test("pseudo - :not", function () {
  ...
  t("reordered compound positional :not()", "#foo p:not(:odd, :first)", [
    "sap",
  ]);

  t("positional :not() with pre-filter", "#foo p:not([id]:first)", [
    "en",
    "sap",
  ]);
  t("positional :not() with post-filter", "#foo p:not(:first[id])", [
    "en",
    "sap",
  ]);
  t("positional :not() with pre-filter", "#foo p:not([lang]:first)", [
    "sndp",
    "sap",
  ]);
  t("positional :not() with post-filter", "#foo p:not(:first[lang])", [
    "sndp",
    "en",
    "sap",
  ]);
...
test("pseudo - position", function () {
  ...
  deepEqual(
    Sizzle("*:lt(2) + *", null, [], Sizzle("#qunit-fixture > p")),
    q("ap"),
...
test("caching", function () {
  ...
  t(
    "Deep ancestry caching in post-positional element matcher (jQuery #14657)",
...
asyncTest(
  "Iframe dispatch should not affect Sizzle, see jQuery #13936",
  1,
  function () {
    var loaded = false,
      thrown = false,
    ...
    jQuery(iframe).on("load", function () {
      ...
      if (loaded) {
        strictEqual(
          thrown,
          false,
          "No error thrown from post-reload Sizzle call"
        );
        start();
      } else {
        loaded = true;
...
test("matchesSelector", function () {
  ...
  ok(
    Sizzle.matchesSelector(el, "[\nrel = bookmark\t]"),
    "unquoted attribute with non-semantic whitespace"
  );
  ...
  ok(
    !Sizzle.matchesSelector(disconnected, "* > *"),
    "child combinator (not matching)"
  );
});
