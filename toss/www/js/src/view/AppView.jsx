  ...
  return React.createClass({
    ...
    componentDidUpdate: function () {
      if (this.state.anim) {
        ...
        var className =
          this.state.anim === "forward" ? "flipped" : "flipped-back";
        ...
        this.state.page !== PAGE.TOSS
          ? function () {
              ...
              var cardOff = (
                <div className={classes._1} ref="cardOff">
                  ...
                  <div className="back">{pagePrev}</div>
                </div>
              );
          ...
          : // else
            function () {
              ...
              var card = [
                <a className={"stop inv shade-" + (this.state.num - 1)}>
                  Stop
                </a>,
