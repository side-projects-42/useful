    ...
    (d.Parser = function (b) {
      ...
      function B(a, b) {
        return a.filename && b.filename && a.filename !== b.filename
          ? o.imports.contents[A(a.filename)]
          : g;
      }
      function C(a, b) {
      ...
      function D(a, b) {
        ...
        (this.type = a.type || "Syntax"),
          ...
          (this.callLine = a.call && C(a.call, c) + 1),
          (this.callExtract = g[C(a.call, c)]),
          (this.stack = a.stack),
          (this.column = f),
              ...
              (m = (function (a) {
                ...
                for (var l = 0, m, n; l < g.length; l++) {
                  (d.lastIndex = l),
                    ...
                    (m = g.charAt(l)),
                    (e.lastIndex = f.lastIndex = l),
                    (i = f.exec(g)) &&
                      i.index === l &&
                      ((l += i[0].length), j.push(i[0]), (m = g.charAt(l))),
                    !k &&
                      m === "/" &&
                      ((n = g.charAt(l + 1)),
                      (n === "/" || n === "*") &&
          ...
          parsers: {
            ...
            entities: {
              ...
              arguments: function () {
                var a = [],
                  b;
                while (
                  (b = w(this.entities.assignment) || w(this.expression))
                ) {
                  a.push(b);
                  if (!w(",")) break;
                }
              ...
              definition: function () {
                ...
                if (
                  ...
                  while (
                    ...
                    e instanceof f.Variable
                      ? w(":")
                        ? ((i = x(this.expression, "expected expression")),
                          b.push({ name: e.name, value: i }))
                        : b.push({ name: e.name })
                      : b.push({ value: e });
                    if (!w(",")) break;
                  }
                  x(")"),
                    w(/^when/) &&
                      (j = x(this.conditions, "expected condition")),
                    (d = w(this.block));
            ...
            rule: function () {
              ...
              if ((a = w(this.variable) || w(this.property))) {
                a.charAt(0) != "@" && (e = /^([^@+\/'"*`(;{}-]*);/.exec(m[i]))
                  ? ((h += e[0].length - 1), (b = new f.Anonymous(e[1])))
                  : a === "font"
                  ? (b = w(this.font))
                  : (b = w(this.value)),
                  (d = w(this.important));
            ...
            import: function () {
              ...
              if (
                w(/^@import\s+/) &&
                (a = w(this.entities.quoted) || w(this.entities.url))
              ) {
                ...
                return (
                  (d = w(/^(?:>=|=<|[<=>])/))
                    ? (b =
                        ...
                        w(this.entities.keyword) ||
                        w(this.entities.quoted))
                      ? (c = new f.Condition(d, a, b, e, g))
                      : y("expected expression")
                    : (c = new f.Condition(
                        "=",
                        a,
                        new f.Keyword("true"),
  ...
  (d.refresh = function (a) {
    ...
    (b = c = new Date()),
      n(function (a, d, e, f, g) {
        g.local
          ? v("loading " + f.href + " from cache.")
          : (v("parsed " + f.href + " successfully."),
            r(d.toCSS(), f, g.lastModified)),
