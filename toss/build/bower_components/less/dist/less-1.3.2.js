...
(function (window, undefined) {
          ...
          do {
            if ((e = $(this.entities.keyword))) {
              ...
              if ($(")")) {
                if (p && e) {
                  nodes.push(
                    new tree.Paren(new tree.Rule(p, e, null, i, true))
                  );
                } else if (e) {
  ...
  (function (tree) {
    tree.functions = {
      ...
      ispixel: function (n) {
        return n instanceof tree.Dimension && n.unit === "px"
          ? tree.True
          : tree.False;
      },
      ...
      isem: function (n) {
        return n instanceof tree.Dimension && n.unit === "em"
          ? tree.True
          : tree.False;
      },
  ...
  function loadStyleSheet(sheet, callback, reload, remaining) {
    ...
    if (less.relativeUrls) {
      if (less.rootpath) {
        if (sheet.entryPath) {
          rootpath = extractUrlParts(
            less.rootpath + pathDiff(hrefParts.path, sheet.entryPath)
          ).path;
        } else {
